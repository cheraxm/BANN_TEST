...
# print(my_dict['winter'][7][0])
# print(my_dict['winter'][7][1])
...
def createRandomSortedList(start = 1, end = 7):
    ...
    # print(flower_dataset['winter'][tmp][0])
    # print(flower_dataset['winter'][tmp][1])
    # print(flower_dataset['winter'][tmp][2])
    # print(flower_dataset['winter'][tmp][3])

    mytest1 = (flower_dataset['winter'][tmp])
    mytest2 = (flower_dataset['winter'][tmp][1])
    mytest3 = (flower_dataset['winter'][tmp][2])
    mytest4 = (flower_dataset['winter'][tmp][3])
...
# createRandomSortedList()
  ...
  # 'summer': {
  #   1:['en_name', 'th_name', 'main-meaning', 'sub-meaning', 'color' ],
  #   2:['en_name', 'th_name', 'main-meaning', 'sub-meaning', 'color' ],
  #   3:['en_name', 'th_name', 'main-meaning', 'sub-meaning', 'color' ],
  #   4:['en_name', 'th_name', 'main-meaning', 'sub-meaning', 'color' ],
  #   5:['en_name', 'th_name', 'main-meaning', 'sub-meaning', 'color' ],
  #   6:['en_name', 'th_name', 'main-meaning', 'sub-meaning', 'color' ],
  #   7:['en_name', 'th_name', 'main-meaning', 'sub-meaning', 'color' ]
